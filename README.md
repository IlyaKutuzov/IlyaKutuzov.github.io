...
In February 2021, amidst the Covid-19 pandemic, the Israeli coastline was covered by vast quantities of a tar-like pollutant. Rapid sampling and subsequent molecular and biomarker analysis allowed me to conclude, within days of the pollution event, that the pollutant was most likely a crude oil rather than tar; this implied a different strategy for source-identification and treatment.<br/> My findings were [submitted](/assets/documents/Feb_2022_oil_spill_report.pdf) to the Israeli Ministry of Environmental Protection (and later to the [press](https://www.globes.co.il/news/article.aspx?did=1001362101)), yet were originally ignored. A year later, the Israeli Ministry of Environment published the result of their analysis and [acknowledged](https://www.gov.il/he/departments/publications/reports/opinion-column_rani_amir) the pollutant is indeed a crude oil.
